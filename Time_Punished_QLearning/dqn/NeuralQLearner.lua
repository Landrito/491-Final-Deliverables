...
function nql:perceive(reward, rawstate, terminal, testing, testing_ep, time_since_last_positive_reward)
    ...
    if reward > 0 then
        reward = reward - 0.003 * time_since_last_positive_reward
...
function nql:createNetwork()
    ...
    for i = 0, 10 do
        net:add(nn.LSTM(args.n_actions, args.n_actions))
    end
